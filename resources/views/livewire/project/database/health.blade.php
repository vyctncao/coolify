    ...
    <div class="flex items-center gap-2">
        ...
        @if (!$healthCheckEnabled)
            <x-modal-confirmation title="Confirm Healthcheck Enable?" buttonTitle="Enable Healthcheck"
                ...
                warningMessage="If the health check fails, this database will be marked unhealthy. Please review the <a href='https://openrail.io/docs/knowledge-base/health-checks' target='_blank' class='underline text-white'>Health Checks</a> guide before proceeding!"
    ...
    <div class="flex flex-col gap-4">
        @if (!$healthCheckEnabled)
            <x-callout type="warning" title="Healthcheck disabled">
                <p>Docker runs no healthcheck probe for this database and OpenRail can no longer report a healthy/unhealthy state.</p>
            </x-callout>
        @endif
