...
#[OA\Info(title: 'OpenRail', version: '0.1')]
#[OA\Server(url: 'https://app.openrail.io/api/v1', description: 'OpenRail Cloud API. Change the host to your own instance if you are self-hosting.')]
#[OA\SecurityScheme(
    type: 'http',
    scheme: 'bearer',
...
class OpenApi
{
    ...
    // for the OpenRail API. It is not a controller and does
